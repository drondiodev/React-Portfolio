          ...
          >
            <div className="qualification__data">
              ...
              <div>
                ...
                <span className="qualification__subtitle">
                  Projet tutoré de 2 mois - Projet en partenariat avec une
                  entreprise
                </span>
                <div className="qualification__calendar">
            ...
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">COMMERCIAL SÉDENTAIRE</h3>
                <span className="qualification__subtitle">MACWAY-JV2R</span>
                <div className="qualification__calendar">
