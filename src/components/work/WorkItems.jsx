    ...
    <div className="work__card" key={item.id}>
      ...
      <div className="work__content">
        ...
        <div className="work__tech">
          {(item.technos).map((stack) => {
            return (
            <p className="work__tech-item">{stack.stack}</p>)
          })}
        </div>
        <a href={item.repo} target="_blank" title="page github associé" className="work__button" rel="noreferrer">
          Repository GitHub <i className="uil uil-github-alt work__button-icon" alt="repository github"></i>
        </a>
      </div>   
    </div>
  )
